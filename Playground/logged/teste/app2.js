...
function validat(item){
    ...
    if(quesNum === 4){
      ...
      mainBody.innerHTML = "<h3>"+"Scorul tau este:"+ score+"/5"+"</h3>"+"<p>"+"Raspunsuri:"+ "</p>"+"<p>"+"1) if"+ "</p>"+ "<p>"+ "2) 48"+ "</p>"+ "<p>"+ "3) de 8 ori"+ "</p>"+ "<p>"+ "4) Cand x are o valoare para"+ "</p>"+ "<p>"+ "5) Afla cmmdc a doua numere"+ "</p>"+ "<h3>"+ "Ai primit 5 banuti pentru participare :)"+ "</h3>" ;
    }
