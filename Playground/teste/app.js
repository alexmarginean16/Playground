...
function validat(item){
    ...
    if(quesNum === 4){
      ...
      mainBody.innerHTML = "<h3>"+"Scorul tau este:"+ score+"/5"+"</h3>"+"<p>"+"Raspunsuri:"+ "</p>"+"<p>"+"1) 24 + 3 = 27"+ "</p>"+ "<p>"+ "2) 6 * 8 = 48"+ "</p>"+ "<p>"+ "3) 2x = 14 => x = 14/2; x = 7"+ "</p>"+ "<p>"+ "4) Triunghiul cu toate laturile egale se numeste triunghi echilateral"+ "</p>"+ "<p>"+ "5) Formula Teoremei lui Pitagora este: ip^2 = c1^2 + c2^2."+ "</p>";
    }
