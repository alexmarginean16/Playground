...
function validat(item){
    ...
    if(quesNum === 4){
      ...
      mainBody.innerHTML = "<h3>"+"Scorul tau este:"+ score+"/5"+"</h3>"+"<p>"+"Raspunsuri:"+ "</p>"+"<p>"+"1) Parte de vorbire"+ "</p>"+ "<p>"+ "2) Parte de propozitie/f.s."+ "</p>"+ "<p>"+ "3) Masculin/feminin"+ "</p>"+ "<p>"+ "4) Pastelul"+ "</p>"+ "<p>"+ "5) Schita"+ "</p>" + "<h3>"+ "Ai primit 5 banuti pentru participare :)"+ "</h3>";
    }
