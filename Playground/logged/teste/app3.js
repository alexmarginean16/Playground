...
function validat(item){
    ...
    if(quesNum === 4){
      ...
      mainBody.innerHTML = "<h3>"+"Scorul tau este:"+ score+"/5"+"</h3>"+"<p>"+"Raspunsuri:"+ "</p>"+"<p>"+"1) Swift"+ "</p>"+ "<p>"+ "2) F#"+ "</p>"+ "<p>"+ "3) assembly language"+ "</p>"+ "<p>"+ "4) Mark Zuckerberg"+ "</p>"+ "<p>"+ "5) SQL"+ "</p>" + "<h3>"+ "Ai primit 5 banuti pentru participare :)"+ "</h3>";
    }
