...
function validat(item){
    ...
    if(quesNum === 4){
      ...
      mainBody.innerHTML = "<h3>"+"Scorul tau este:"+ score+"/5"+"</h3>"+"<p>"+"Raspunsuri:"+ "</p>"+"<p>"+"1) Am vazut flori frumoase in San Francisco"+ "</p>"+ "<p>"+ "2) ate"+ "</p>"+ "<p>"+ "3) S + V(la trecut)"+ "</p>"+ "<p>"+ "4) Windshield"+ "</p>"+ "<p>"+ "5) nimic"+ "</p>"+ "<h3>"+ "Ai primit 5 banuti pentru participare :)"+ "</h3>";
    }
